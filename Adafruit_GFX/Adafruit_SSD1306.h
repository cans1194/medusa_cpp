...
{
public:
	Adafruit_SSD1306(PinName RST, PinName SA0, uint8_t rawHeight = 64, uint8_t rawWidth = 128)
		: Adafruit_GFX(rawWidth,rawHeight)
		, rst(RST,false), sa0(SA0, false)
	{
...
public:
	 ...
	 */
	Adafruit_SSD1306_Spi(SPI &spi, PinName DC, PinName RST, PinName SA0, PinName CS, uint8_t rawHieght = 32, uint8_t rawWidth = 128)
	    : Adafruit_SSD1306(RST, SA0, rawHieght, rawWidth)
	    , cs(CS,true)
	    , dc(DC,false)
	    , mspi(spi)
	    {
...
public:
	 ...
	 * @param rawWidth - The horizonal number of pixels for the display, defaults to 128
	 */
	Adafruit_SSD1306_I2c(I2C &i2c, PinName RST, PinName SA0, uint8_t i2cAddress = SSD_I2C_ADDRESS, uint8_t rawHeight = 64, uint8_t rawWidth = 128)
	    : Adafruit_SSD1306(RST, SA0, rawHeight, rawWidth)
	    , mi2c(i2c)
